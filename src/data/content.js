...
DATA.storylines = {
  wanderer: {
    ...
    bosses: {
      1: { id: "wanderer_boss_y1", name: "青旗堂主·陆闻川", icon: "刀", year: 1, hp: 2000, qi: 620, atk: 108, def: 64, combo: 4, hit: 76, dodge: 8, crit: 12, speed: 1.48, boss: true, bossTrait: "bleedPer3", bossTraitDesc: "每3回合对玩家叠加2层流血；直接伤害附带轻破防" },
      2: { id: "wanderer_boss_y2", name: "执法长老·孟天衡", icon: "掌", year: 2, hp: 3800, qi: 1050, atk: 150, def: 105, combo: 5, hit: 84, dodge: 10, crit: 14, speed: 1.58, boss: true, bossTrait: "hamstringCap", bossTraitDesc: "断筋上限+2；玩家速度最低可被压到70%" },
      3: { id: "wanderer_final", name: "武盟帮主·岳宗玄", icon: "魔", year: 3, hp: 7600, qi: 2100, atk: 225, def: 165, combo: 8, hit: 92, dodge: 16, crit: 22, speed: 1.72, boss: true, bossTrait: "shieldCleanCounter", bossTraitDesc: "开场25%护体；50%血净化一次；低血反击" }
    },
    events: [
  ...
  constable: {
    ...
    threatDesc: "内廷爪牙渗透日深",
    bosses: {
      1: { id: "constable_boss_y1", name: "东厂档头·韩玉阙", icon: "镖", year: 1, hp: 1850, qi: 700, atk: 100, def: 58, combo: 5, hit: 86, dodge: 10, crit: 10, speed: 1.60, boss: true, bossTrait: "highHitPoison", bossTraitDesc: "暗器命中高；毒层结算后自然衰减" },
      2: { id: "constable_boss_y2", name: "锦衣指挥使·沈镇岳", icon: "刀", year: 2, hp: 3600, qi: 980, atk: 165, def: 92, combo: 6, hit: 88, dodge: 12, crit: 20, speed: 1.62, boss: true, bossTrait: "critBreakDef", bossTraitDesc: "暴击破防；玩家防御最多被压到75%" },
      3: { id: "constable_final", name: "司礼监掌印·魏承恩", icon: "魔", year: 3, hp: 7200, qi: 2300, atk: 210, def: 145, combo: 7, hit: 95, dodge: 20, crit: 18, speed: 1.82, boss: true, bossTrait: "drainQiImmuneBurst", bossTraitDesc: "每回合吸内；前3回合免疫负面；内力低时爆发" }
    },
    events: [
  ...
  orthodox: {
    ...
    threatDesc: "鬼教势力暗中蔓延",
    bosses: {
      1: { id: "orthodox_boss_y1", name: "鬼教香主·白无咎", icon: "毒", year: 1, hp: 1900, qi: 760, atk: 96, def: 60, combo: 5, hit: 78, dodge: 12, crit: 10, speed: 1.52, boss: true, bossTrait: "poisonGuPerTurn", bossTraitDesc: "每回合毒+1蛊+1；每回合只衰减一种负面" },
      2: { id: "orthodox_boss_y2", name: "黑莲护法·桑暮雨", icon: "魔", year: 2, hp: 3900, qi: 1200, atk: 145, def: 95, combo: 6, hit: 84, dodge: 16, crit: 14, speed: 1.65, boss: true, bossTrait: "drainQiLowShield", bossTraitDesc: "命中吸内；低血获得15%护体" },
      3: { id: "orthodox_final", name: "鬼教掌门·夜摩罗", icon: "魔", year: 3, hp: 7800, qi: 2200, atk: 220, def: 150, combo: 8, hit: 90, dodge: 22, crit: 20, speed: 1.78, boss: true, bossTrait: "poisonGuCapCleanse", bossTraitDesc: "毒蛊上限+3；50%血时净化并回血20%" }
    },
    events: [
