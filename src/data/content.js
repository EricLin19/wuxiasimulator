...
// 小Boss池（通用）
DATA.miniBosses = [
  { id: "mini_bleed_blade", name: "血刀客", icon: "刀", portraitImage: "assets/portraits_pixel/mini_bleed_blade_pixel_320.webp", yearMin: 2, hp: 1400, qi: 420, atk: 85, def: 45, combo: 4, hit: 72, dodge: 6, crit: 10, speed: 1.42, boss: true, bossTrait: "miniBleed", bossTraitDesc: "每回合流血+5", rank: 3, taunt: "流血三尺，方显刀意。" },
  { id: "mini_frost_assassin", name: "寒衣刺客", icon: "影", portraitImage: "assets/portraits_pixel/mini_frost_assassin_pixel_320.webp", yearMin: 2, hp: 1200, qi: 500, atk: 78, def: 38, combo: 5, hit: 80, dodge: 28, crit: 12, speed: 1.70, boss: true, bossTrait: "miniFrost", bossTraitDesc: "每回合寒气+5，高闪避", rank: 3, taunt: "寒气入脉，你跑不了。" },
  ...
  { id: "mini_armor_monk", name: "玄甲武师", icon: "甲", portraitImage: "assets/portraits_pixel/mini_armor_monk_pixel_320.webp", yearMin: 3, hp: 3600, qi: 1000, atk: 150, def: 130, combo: 3, hit: 82, dodge: 8, crit: 10, speed: 1.35, boss: true, bossTrait: "miniArmor", bossTraitDesc: "开场30%护体，高防稳守", rank: 5, taunt: "金钟罩下，你破不了防。" }
];
...
DATA.wandererEnemyPool = {
  ...
  miniBosses: [
    { id: "wanderer_mini_zhoutong", name: "铁手·周通", icon: "拳", portraitImage: "assets/portraits_pixel/qiSuppressFist_pixel_320.webp", yearMin: 1, hp: 1800, qi: 500, atk: 75, def: 52, combo: 5, hit: 80, dodge: 8, crit: 12, speed: 1.42, boss: true, bossTrait: "miniBleed", bossTraitDesc: "每回合流血+5", rank: 2, taunt: "奉命'劝导'拒册散人。劝不听的话——我这双手套开过不少瓢。" },
    ...
    { id: "wanderer_mini_liuchangqing", name: "寒剑·柳长卿", icon: "剑", portraitImage: "assets/portraits_pixel/highDodgeAssassin_pixel_320.webp", yearMin: 2, hp: 3000, qi: 850, atk: 105, def: 62, combo: 6, hit: 86, dodge: 18, crit: 15, speed: 1.65, boss: true, bossTrait: "miniFrost", bossTraitDesc: "每回合寒气+5，减速削内", rank: 3, taunt: "愿入籍从优，不必去外编队——这对你来说，是恩赐。" },
    ...
    { id: "wanderer_mini_qianbiao", name: "狂刀·钱彪", icon: "刀", portraitImage: "assets/portraits_pixel/mini_bleed_blade_pixel_320.webp", yearMin: 2, hp: 2800, qi: 680, atk: 115, def: 55, combo: 5, hit: 82, dodge: 10, crit: 14, speed: 1.48, boss: true, bossTrait: "lowHpBerserk", bossTraitDesc: "≤30%HP：ATK×1.5,SPEED×3", rank: 3, taunt: "统领建立的新秩序，需要你们这些散人做出点牺牲。" },
    ...
    { id: "wanderer_mini_gongsunlie", name: "右护法·公孙烈", icon: "枪", portraitImage: "assets/portraits_pixel/armorBreakBlade_pixel_320.webp", yearMin: 3, hp: 7000, qi: 1800, atk: 185, def: 120, combo: 6, hit: 85, dodge: 10, crit: 16, speed: 1.52, boss: true, bossTrait: "armorBreak", bossTraitDesc: "玩家DEF剩50%；每次命中DEF-5%", rank: 6, taunt: "统领说打谁就打谁。我不问为什么。" }
  ]
};
