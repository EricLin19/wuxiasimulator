...
DATA.wandererEnemyPool = {
  ...
  miniBosses: [
    ...
    { id: "wanderer_mini_liuchangqing", name: "寒剑·柳长卿", icon: "剑", portraitImage: "assets/portraits_pixel/blade_pixel_320.webp", yearMin: 2, hp: 3000, qi: 850, atk: 105, def: 62, combo: 6, hit: 86, dodge: 18, crit: 15, speed: 1.65, boss: true, bossTrait: "miniFrost", bossTraitDesc: "寒霜剑气，寒气+2", rank: 3, taunt: "愿入籍从优，不必去外编队——这对你来说，是恩赐。" },
