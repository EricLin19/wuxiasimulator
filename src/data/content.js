...
export const DATA = {
  ...
  enemies: [
    ...
    { id: "main_m22_ye_gu", name: "无影·叶孤", icon: "影", portraitImage: "assets/portraits_guyun_pixel/main_m22_ye_gu_pixel_320.webp", hp: 4500, qi: 1000, atk: 170, def: 68, combo: 7, hit: 88, dodge: 50, crit: 18, speed: 1.80, rank: 4, boss: true, bossTraits: ["bloodBlade", "veinBreak"], bossTraitDesc: "每回合流血+4（血刃）、断脉+4，上限15层", taunt: "我要的不是你的命，是那份名单。交出来，你可以活。" },
    ...
    { id: "main_m26_qian_biao", name: "狂刀·钱彪", icon: "刀", portraitImage: "assets/portraits_guyun_pixel/main_m26_qian_biao_pixel_320.webp", hp: 5000, qi: 1100, atk: 185, def: 74, combo: 5, hit: 82, dodge: 10, crit: 14, speed: 1.60, rank: 5, boss: true, bossTraits: ["hamstringStrike"], bossTraitDesc: "每回合断筋+5，上限15层", taunt: "统领建立的新秩序，需要你们这些散人做出点牺牲。" },
    ...
    { id: "main_m30_huo_feng", name: "烽火统领·霍烽", icon: "烽", portraitImage: "assets/portraits_guyun_pixel/main_m30_huo_feng_pixel_320.webp", hp: 6000, qi: 1400, atk: 215, def: 86, combo: 5, hit: 85, dodge: 9, crit: 16, speed: 1.70, rank: 6, boss: true, bossTraits: ["celestialShield"], bossTraitDesc: "开场30%HP天罡护体", taunt: "太行外围百里之内，没有我的狼烟传不到的信号。" },
...
DATA.miniBosses = [
  ...
  { id: "mini_armor_monk", name: "玄甲武师", icon: "甲", portraitImage: "assets/portraits_pixel/mini_armor_monk_pixel_320.webp", yearMin: 3, hp: 3600, qi: 1000, atk: 150, def: 130, combo: 3, hit: 82, dodge: 8, crit: 10, speed: 1.35, boss: true, bossTraits: ["miniArmor"], bossTraitDesc: "开场30%护体，高防稳守", rank: 5, taunt: "金钟罩下，你破不了防。" }
];
...
DATA.wandererEnemyPool = {
  ...
  miniBosses: [
    { id: "wanderer_mini_zhoutong", name: "铁手·周通", icon: "拳", portraitImage: "assets/portraits_pixel/qiSuppressFist_pixel_320.webp", yearMin: 1, hp: 1800, qi: 500, atk: 75, def: 52, combo: 5, hit: 80, dodge: 8, crit: 12, speed: 1.42, boss: true, bossTraits: ["miniBleed"], bossTraitDesc: "每回合流血+5", rank: 2, taunt: "奉命'劝导'拒册散人。劝不听的话——我这双手套开过不少瓢。" },
    { id: "wanderer_mini_zhishi", name: "堂口执事", icon: "吏", portraitImage: "assets/portraits_pixel/rogue_pixel_320.webp", yearMin: 1, hp: 800, qi: 200, atk: 38, def: 18, combo: 3, hit: 65, dodge: 5, crit: 5, speed: 1.15, boss: true, bossTraits: [], bossTraitDesc: null, rank: 1, taunt: "五百两五十人，这批货不错。" },
    { id: "wanderer_mini_liuchangqing", name: "寒剑·柳长卿", icon: "剑", portraitImage: "assets/portraits_pixel/highDodgeAssassin_pixel_320.webp", yearMin: 2, hp: 3000, qi: 850, atk: 105, def: 62, combo: 6, hit: 86, dodge: 18, crit: 15, speed: 1.65, boss: true, bossTraits: ["miniFrost"], bossTraitDesc: "每回合寒气+5，减速削内", rank: 3, taunt: "愿入籍从优，不必去外编队——这对你来说，是恩赐。" },
    { id: "wanderer_mini_yegu", name: "无影·叶孤", icon: "影", portraitImage: "assets/portraits_pixel/highDodgeAssassin_pixel_320.webp", yearMin: 2, hp: 2200, qi: 720, atk: 95, def: 40, combo: 7, hit: 88, dodge: 30, crit: 18, speed: 1.80, boss: true, bossTraits: ["highDodge"], bossTraitDesc: "极速暗杀，闪避+15", rank: 3, taunt: "我要的不是你的命，是那份名单。交出来，你可以活。" },
    { id: "wanderer_mini_qianbiao", name: "狂刀·钱彪", icon: "刀", portraitImage: "assets/portraits_pixel/mini_bleed_blade_pixel_320.webp", yearMin: 2, hp: 2800, qi: 680, atk: 115, def: 55, combo: 5, hit: 82, dodge: 10, crit: 14, speed: 1.48, boss: true, bossTraits: ["lowHpBerserk"], bossTraitDesc: "≤30%HP：ATK×1.5,SPEED×3", rank: 3, taunt: "统领建立的新秩序，需要你们这些散人做出点牺牲。" },
    { id: "wanderer_mini_kanzhang", name: "地牢看守长", icon: "牢", portraitImage: "assets/portraits_pixel/demon_pixel_320.webp", yearMin: 2, hp: 2500, qi: 780, atk: 90, def: 68, combo: 4, hit: 80, dodge: 12, crit: 10, speed: 1.38, boss: true, bossTraits: ["pointStrike"], bossTraitDesc: "判官笔专打穴道，概率封行动", rank: 3, taunt: "换班的间隙只有一炷香。你们来得不是时候。" },
    { id: "wanderer_mini_gongsunlie", name: "右护法·公孙烈", icon: "枪", portraitImage: "assets/portraits_pixel/armorBreakBlade_pixel_320.webp", yearMin: 3, hp: 7000, qi: 1800, atk: 185, def: 120, combo: 6, hit: 85, dodge: 10, crit: 16, speed: 1.52, boss: true, bossTraits: ["armorBreak"], bossTraitDesc: "玩家DEF剩50%；每次命中DEF-5%", rank: 6, taunt: "统领说打谁就打谁。我不问为什么。" }
  ]
};
